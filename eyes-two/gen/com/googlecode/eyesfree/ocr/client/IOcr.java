 ...
 * Original file: D:\\EclipesWorkSpace\\eyes-two\\src\\com\\googlecode\\eyesfree\\ocr\\client\\IOcr.aidl
 */
...
@Override public void setCallback(com.googlecode.eyesfree.ocr.client.IOcrCallback callback) throws android.os.RemoteException
{
...
@Override public long enqueueData(byte[] jpegData, com.googlecode.eyesfree.ocr.client.Ocr.Parameters params) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
...
@Override public long enqueueFile(java.lang.String filename, com.googlecode.eyesfree.ocr.client.Ocr.Parameters params) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
...
@Override public boolean cancel(long taskId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public boolean reloadLanguages() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public java.util.List<com.googlecode.eyesfree.ocr.client.Language> getAvailableLanguages() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public java.lang.String getTessdata() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public java.lang.String getDatapath() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
