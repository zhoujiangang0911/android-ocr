 ...
 * Original file: D:\\EclipesWorkSpace\\eyes-two\\src\\com\\googlecode\\eyesfree\\ocr\\client\\IOcrCallback.aidl
 */
...
@Override public void onResult(long token, com.googlecode.eyesfree.ocr.client.OcrResult results) throws android.os.RemoteException
{
...
@Override public void onCompleted(long token, java.util.List<com.googlecode.eyesfree.ocr.client.OcrResult> results) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
